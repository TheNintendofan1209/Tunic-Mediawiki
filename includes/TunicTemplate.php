<?php
/**
 * BaseTemplate class for the Tunic skin
 * This code will be migrated into SkinTunic. Please use SkinTunic
 * and skin.mustache from now on.
 *
 * @ingroup Skins
 */
class TunicTemplate extends BaseTemplate {
	/**
	...
	public function execute() {
		return [
			'html-tunic-footer' => $this->getFooterHTML(),
		];
	}
